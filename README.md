# `OpenBLASHighCoreCount_jll.jl` (v0.3.12+1)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/9d1fdad6ef8ec613d19b8403d2f82c7e33476dfa/O/OpenBLAS/OpenBLASHighCoreCount@0.3.12/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.  If you have any issue, please report it to the Yggdrasil [bug tracker](https://github.com/JuliaPackaging/Yggdrasil/issues).

For more details about JLL packages and how to use them, see `BinaryBuilder.jl` [documentation](https://juliapackaging.github.io/BinaryBuilder.jl/dev/jll/).

## Sources

The tarballs for `OpenBLASHighCoreCount_jll.jl` have been built from these sources:

* compressed archive: https://github.com/xianyi/OpenBLAS/archive/v0.3.12.tar.gz (SHA256 checksum: `65a7d3a4010a4e3bd5c0baa41a234797cd3a1735449a4a5902129152601dc57b`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/9d1fdad6ef8ec613d19b8403d2f82c7e33476dfa/O/OpenBLAS/OpenBLASHighCoreCount@0.3.12/bundled)

## Platforms

`OpenBLASHighCoreCount_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `OpenBLASHighCoreCount_jll.jl`:
