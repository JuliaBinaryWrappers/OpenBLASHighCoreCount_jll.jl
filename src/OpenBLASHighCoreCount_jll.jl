module OpenBLASHighCoreCount_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OpenBLASHighCoreCount_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3a2d25a1-7f54-53f7-aded-df035e2fc6f8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OpenBLASHighCoreCount", artifacts_toml) for e in artifacts["OpenBLASHighCoreCount"]]
...
if best_platform === nothing
    @debug("Unable to load OpenBLASHighCoreCount; unsupported platform $(triplet(platform_key_abi()))")
else
